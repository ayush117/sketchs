    ...
    return <>
        <div className="file-select-continer basis-2/4">
            ...
            <div className="flex pt-2 justify-between">
                <div className="flex text-white bg-purple-900 px-5 py-2 rounded border-2 border-white hover:bg-purple-700 hover:text-black hover:border-black" style={{flexBasis: "30%"}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
